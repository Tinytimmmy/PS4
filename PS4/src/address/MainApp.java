...
public class MainApp extends Application {
	...
	/**
	 * Returns the data as an obserable list of Persons.
	 * @return
	 */
	...
	/**
	 * Loads perosn data from the specified file. The current person data will
	 * be replaced.
	 * 
	 * @param file
	 */
	...
	/**
	 * Saves the current person data to the specefied file.
	 * 
	 * @param file
	 */
